...
class ChataDataset(torch.utils.data.Dataset):
    ...
    def map_class_id_to_class_name(self, class_id):
        return ChataDataset.CLASSES[class_id]
...
class ChartsDataset(torch.utils.data.Dataset):
    ...
    def map_class_id_to_class_name(self, class_id):
        return ChartsDataset.CLASSES[class_id]

class TablesDataset(torch.utils.data.Dataset):
    ...
    def map_class_id_to_class_name(self, class_id):
        return TablesDataset.CLASSES[class_id]
